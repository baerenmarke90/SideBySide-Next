...
class ProjectIdentityMigrationContractTest(unittest.TestCase):
    ...
    def test_repository_rename_is_documented_as_deferred(self) -> None:
        guide = read("docs/PROJECT-IDENTITY-MIGRATION.md")
        self.assertIn("Final GitHub repository rename — deferred", guide)
        self.assertIn("not part of the implementation commit", guide)
