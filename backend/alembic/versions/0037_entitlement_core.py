...
def upgrade() -> None:
    op.create_table(
        ...
        sa.CheckConstraint(
            "source_type IN ('GOOGLE_PLAY', 'CLOUD_STRIPE', 'SELF_HOSTED_KEY', 'ADMIN_GRANT', 'TEST_FIXTURE')",
...
def downgrade() -> None:
    op.drop_index("ix_entitlement_grants_space_id_status", table_name="entitlement_grants")
    op.drop_index("ix_entitlement_grants_account_id", table_name="entitlement_grants")
    op.drop_index("ix_entitlement_grants_space_id", table_name="entitlement_grants")
