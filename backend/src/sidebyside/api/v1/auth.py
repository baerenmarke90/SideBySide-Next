...
@router.post("/auth/register", response_model=SessionView, status_code=status.HTTP_201_CREATED)
...
@router.post("/auth/sign-in", response_model=SessionView)
...
@router.post("/auth/refresh", response_model=TokenView)
