...
EXPECTED_PROBLEM_RESPONSES: dict[tuple[str, str], set[int]] = {
    ...
    ("/api/v1/auth/magic-link/request", "post"): {403, 422, 429, 503},
    ("/api/v1/auth/magic-link/consume", "post"): {403, 422},
    ...
    ("/api/v1/auth/oidc/{connectionId}/start", "post"): {403, 422, 429},
    ("/api/v1/auth/oidc/{connectionId}/link", "post"): {401, 403, 422, 429},
    ("/api/v1/auth/oidc/{connectionId}/callback", "post"): {401, 403, 409, 422},
    ("/api/v1/auth/passkeys/registration/start", "post"): {401, 403},
    ("/api/v1/auth/passkeys/registration/finish", "post"): {401, 403, 422},
    ("/api/v1/auth/passkeys/authentication/start", "post"): {403, 422, 429},
    ("/api/v1/auth/passkeys/authentication/finish", "post"): {401, 403, 422},
