...
SPACE_ENDPOINTS: tuple[Endpoint, ...] = (
    ...
    Endpoint(
        "GET",
        "/api/v1/spaces/{spaceId}/places/{placeId}/relations",
        resource_absence="PLACE_NOT_FOUND",
    ),
    Endpoint(
        "PUT",
        "/api/v1/spaces/{spaceId}/places/{placeId}/relations/{targetType}/{targetId}",
        body={},
        resource_absence="PLACE_NOT_FOUND",
    ...
    Endpoint(
        "GET",
        "/api/v1/spaces/{spaceId}/chapters/{chapterId}/relations",
        resource_absence="CHAPTER_NOT_FOUND",
    ),
    Endpoint(
        "PUT",
        "/api/v1/spaces/{spaceId}/chapters/{chapterId}/relations/{targetType}/{targetId}",
        body={},
        resource_absence="CHAPTER_NOT_FOUND",
        placeholders=("chapterId",),
    ),
    Endpoint(
        "DELETE",
        "/api/v1/spaces/{spaceId}/chapters/{chapterId}/relations/{targetType}/{targetId}",
    ...
    Endpoint(
        "POST",
        "/api/v1/spaces/{spaceId}/collections/{collectionId}/items/{itemId}/plan",
        body={},
        if_match=True,
        resource_absence="COLLECTION_ITEM_NOT_FOUND",
    ),
    Endpoint(
        "POST",
        "/api/v1/spaces/{spaceId}/collections/{collectionId}/items/{itemId}/return",
        body={},
        if_match=True,
        resource_absence="COLLECTION_ITEM_NOT_FOUND",
    ),
    Endpoint("GET", "/api/v1/spaces/{spaceId}/private/collections"),
    Endpoint("POST", "/api/v1/spaces/{spaceId}/private/collections", body=PRIVATE_COLLECTION),
    Endpoint(
        "GET",
