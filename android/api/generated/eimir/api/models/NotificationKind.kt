...
enum class NotificationKind(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is NotificationKind) "$data" else null

        /**
         * Returns a valid [NotificationKind] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): NotificationKind? = data?.let {
