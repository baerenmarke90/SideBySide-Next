...
import de.eimir.app.design.BrandLockup
    ...
    Column(
        ...
        if (notice != null) {
            Surface(
                ...
                color = EimirTheme.colors.warningSurface,
                ...
                Text(
                    ...
                    modifier = Modifier
                        .padding(EimirTheme.spacing.step4)
        ...
        Text(
            ...
            color = EimirTheme.colors.textMuted,
            modifier = Modifier.widthIn(max = ReadingMeasure),
        )
    }
}
