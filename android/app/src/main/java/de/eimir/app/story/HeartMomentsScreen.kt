...
private fun HeartMomentCard(
    ...
    Surface(
        shape = RoundedCornerShape(EimirTheme.radii.card),
        color = if (private) EimirTheme.colors.privateSurface else EimirTheme.colors.surface,
        modifier = Modifier.fillMaxWidth(),
    ) {
        Column(
            modifier = Modifier.padding(EimirTheme.spacing.cardPadding),
            ...
            Text(
                ...
                color = if (private) EimirTheme.colors.private else EimirTheme.colors.shared,
            )
            Text(
                text = moment.text,
                style = MaterialTheme.typography.bodyLarge,
