...
import de.eimir.app.shell.WindowWidthClass
import de.eimir.app.shell.windowWidthClassFor
    ...
    LazyColumn(
        ...
        cachedAt?.let {
            item(key = "cached-banner") {
                de.eimir.app.shell.CachedContentBanner(it)
            }
        }
    ...
    Column(
        ...
        Surface(
            ...
            Column {
                ...
                HorizontalDivider(color = EimirTheme.colors.borderSubtle)
...
private fun SectionHeading(labelRes: Int, modifier: Modifier = Modifier) {
    Text(
        ...
        color = EimirTheme.colors.brandStrong,
        modifier = modifier
            .padding(top = EimirTheme.spacing.step4)
            .semantics { heading() },
    )
}
