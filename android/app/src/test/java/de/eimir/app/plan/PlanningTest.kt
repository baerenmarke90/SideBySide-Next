...
import de.eimir.app.reference.planScheduleStart
...
private class PlanningApi(
    ...
    val wishUpdates = mutableListOf<eimir.api.models.WishUpdate>()
    val wishUpdateVersions = mutableListOf<Int>()
    val conversions = mutableListOf<WishToPlan>()
    val planWishVersions = mutableListOf<Int>()
    val directlyCreated = mutableListOf<eimir.api.models.PlanCreate>()
    val planUpdates = mutableListOf<eimir.api.models.PlanUpdate>()
    ...
    override suspend fun updateWish(
        ...
        wishId: UUID,
        ifMatch: Int,
        update: eimir.api.models.WishUpdate,
    ): WishDetail {
    ...
    override suspend fun updatePlan(
        ...
        planId: UUID,
        ifMatch: Int,
        update: eimir.api.models.PlanUpdate,
    ): PlanDetail {
