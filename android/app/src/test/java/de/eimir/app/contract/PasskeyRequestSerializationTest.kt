package de.eimir.app.contract

import de.eimir.app.reference.EimirJson
...
import eimir.api.models.PasskeyAuthenticationRequest
import eimir.api.models.PasskeyRegistrationRequest
...
class PasskeyRequestSerializationTest {
    ...
    fun carriesANestedCredentialThroughSerializationUnchanged() {
        ...
        val encoded = EimirJson.encodeToString(
            PasskeyAuthenticationRequest.serializer(),
            request,
        )
        val decoded = EimirJson.decodeFromString(
            PasskeyAuthenticationRequest.serializer(),
            encoded,
        )
    ...
    fun writesTheCredentialAsAnObjectRatherThanAsAString() {
        ...
        val encoded = EimirJson.parseToJsonElement(
            EimirJson.encodeToString(PasskeyRegistrationRequest.serializer(), request),
        )
